        ...
        <div class="form-box">
            <form id="form-delivery">
                ...
                <div class="form-group">
                    ...
                    <textarea id="endereco" name="endereco" rows="3" placeholder="Rua, Número, Bairro, Complemento..."
                        required></textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group half">
                        ...
                        <input type="date" id="data_entrega" name="data_entrega" min="<?php echo date('Y-m-d'); ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="obs" name="obs" rows="2"
                        placeholder="Ex: Tocar interfone, deixar na portaria..."></textarea>
                </div>
    ...
    <div id="print-area">
        <div class="etiqueta-termica">
            <div class="header-etiqueta">
                <img src="../static/img/cacaushow.png" alt="Logo" class="logo-print"><br>
                <h3>DELIVERY</h3>
            </div>
